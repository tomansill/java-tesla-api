...
public final class Vehicle{
  ...
  @Nonnull
  public static Vehicle convert(@Nonnull com.ansill.tesla.api.low.model.VehicleResponse vehicle){
    return convert(vehicle.getResponse());
  }

  @Nonnull
  public static Vehicle convert(@Nonnull com.ansill.tesla.api.low.model.Vehicle vehicle){
