...
public final class VehicleState{
    ...
    @Nonnull
    public static VehicleState convert(@Nonnull com.ansill.tesla.api.low.model.VehicleState state){
    ...
    public static class MediaState{
        ...
        @Nonnull
        public static MediaState convert(@Nonnull com.ansill.tesla.api.low.model.VehicleState.MediaState state){
    ...
    public static class SoftwareUpdate{
        ...
        @Nonnull
        public static SoftwareUpdate convert(@Nonnull com.ansill.tesla.api.low.model.VehicleState.SoftwareUpdate update){
