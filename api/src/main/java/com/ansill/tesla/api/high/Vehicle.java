...
public class Vehicle{
   ...
   * <p>
   * **NOTE:** This method will wait for vehicle to wake up before finishing
   *
   * @throws VehicleNotFoundException in a rare event if vehicle gets removed from the account, this exception will be thrown
   */
   ...
   * Wakes the vehicle up
   *
   * @param wait true to wait for vehicle to wake up, false to not wait for vehicle to wake up before finishing
   * @throws VehicleNotFoundException in a rare event if vehicle gets removed from the account, this exception will be thrown
   */
  public void wakeUp(boolean wait) throws VehicleNotFoundException{
